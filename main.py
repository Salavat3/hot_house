...
def main():
    ...
    layoutAirAndGround = [
        [sg.Text('Air')],
        [sg.HSeparator()],
        [sg.Table(values=airTableData, headings=airTableHeadings, auto_size_columns=True, display_row_numbers=False, key='-TABLE-AIR-')],
        [
        ...
        [sg.Text('Ground')],
        [sg.HSeparator()],
        [sg.Table(values=groundTableData, headings=groundTableHeadings, auto_size_columns=True, display_row_numbers=False, key='-TABLE-GND-')],
        [
            sg.Text('Gates:'),
    ...
    window = sg.Window('MIET HotHouse Reader', windowLayout, resizable=False, margins=(0,0), size=(1000,510), finalize=True)
